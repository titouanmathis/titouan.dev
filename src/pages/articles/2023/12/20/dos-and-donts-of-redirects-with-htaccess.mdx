...
I have spent many hours configuring thousands of redirects when migrating a website. I am sharing some of the do's and don'ts I recommend to follow when working on this kind of tasks.
