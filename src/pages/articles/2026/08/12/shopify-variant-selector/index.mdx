...
The selector above derives price, label and button state from the option inputs, declared entirely in markup, with Shopify rendering the authoritative price. For the section-swapping mechanics, see the [Section Rendering API example](/articles/2026/07/29/shopify-section-rendering-api-example/).

:::info[Next article]
The [AJAX cart drawer](/articles/2026/08/19/shopify-ajax-cart-drawer/) adds the selected variant to the cart and opens a drawer without a reload.
:::
