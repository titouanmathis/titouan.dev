...
<div class="tracking-wide uppercase opacity-50"><small>15/06/2022 in #PHP #scripts #terminal</small></div>
...
function pvm() {
    ...
    function get_php_bin_path() {
        find /usr/local/Cellar -path "*/php*/$1*" -type d -name 'bin' -maxdepth 5
    }

    function get_php_versions() {
        find /usr/local/Cellar -path '*/php*/*' -name '*' -maxdepth 2 -mindepth 2 | grep -E -o '/[0-9]+.[0-9]+' | sed -E 's#/##'
    }
