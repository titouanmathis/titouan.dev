...
The `--signoff` flag will add a line about the original author of the commit wuile the `--keep` one will avoid striping content in brackets from the commit message.
