...
<PreviewPlayground
  html={() => import('./demo-bug.twig?raw')}
  script={() => import('./demo.js?raw')}
  css={() => import('./demo.css?raw')}></PreviewPlayground>
...
<div class="overflow-hidden rounded max-w-lg">
  <video muted autoplay loop class="dark:hidden scale-105">
    <source src="/2025/09/30/input-glitch-light.mp4" type="video/mp4" />
  </video>
  <video muted autoplay loop class="hidden dark:block scale-105">
...
<PreviewPlayground
  html={() => import('./demo-fixed.twig?raw')}
  script={() => import('./demo.js?raw')}
  css={() => import('./demo.css?raw')}></PreviewPlayground>
