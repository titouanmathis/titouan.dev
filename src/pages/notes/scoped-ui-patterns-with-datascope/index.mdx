...
<div data-component="DataScope" data-option-group="person">
  <input name="first" value="Grace" data-component="DataModel" data-option-immediate />
  <input name="last" value="Hopper" data-component="DataModel" data-option-immediate />
